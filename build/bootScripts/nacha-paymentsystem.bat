...
set JARPATH=%APP_HOME%\lib\nacha-paymentsystem-1.0-SNAPSHOT.jar

@rem Execute nacha-paymentsystem
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NACHA_PAYMENTSYSTEM_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%NACHA_PAYMENTSYSTEM_EXIT_CONSOLE%" exit 1
exit /b 1
